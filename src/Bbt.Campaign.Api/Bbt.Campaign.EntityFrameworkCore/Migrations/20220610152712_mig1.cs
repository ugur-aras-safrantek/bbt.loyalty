...
namespace Bbt.Campaign.EntityFrameworkCore.Migrations
{
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TopLimits_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "CampaignUpdatePages",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CampaignId = table.Column<int>(type: "int", nullable: false),
                    IsCampaignUpdated = table.Column<bool>(type: "bit", nullable: false),
                    IsCampaignRuleUpdated = table.Column<bool>(type: "bit", nullable: false),
                    IsCampaignTargetUpdated = table.Column<bool>(type: "bit", nullable: false),
                    IsCampaignChannelCodeUpdated = table.Column<bool>(type: "bit", nullable: false),
                    IsCampaignAchievementUpdated = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignUpdatePages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CampaignUpdatePages_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignUpdatePages_CampaignId",
                table: "CampaignUpdatePages",
                column: "CampaignId");
